namespace GameFrame.Core
{
     public partial class WebRequestManager
    {
        ...
        private sealed class WebRequestAgent : ITaskAgent<WebRequestTask>
        {
            ...
            public GameFrameworkAction<WebRequestAgent, string, byte[]> WebRequestAgentFailure;
            ...
            public WebRequestAgent(IWebRequestAgentHelper webRequestAgentHelper)
            {
                ...
                {
                    throw new GameFrameException("Web request agent helper is invalid.");
                }
            ...
            public void Start(WebRequestTask task)
            {
                if (task == null)
                {
                    throw new GameFrameException("Task is invalid.");
                }
            ...
            private void OnWebRequestAgentHelperError(object sender, WebRequestAgentHelperErrorEventArgs e)
            {
                ...
                {
                    WebRequestAgentFailure(this, e.ErrorMessage, e.GetWebResponseBytes());
                }
