...
namespace GameFrame.Utility.UI
{
    ...
    public static class TMP_DefaultControlsPro
    {
        ...
        public static GameObject CreateDropdown(Resources resources)
        {
            ...
            GameObject mask = CreateUIObject("Template", root);
            GameObject template = CreateUIObject("Scroll", mask);
            ...
            // Setup Mask
            var maskScript = mask.AddComponent<RectMask2D>();
            ...
            TMP_DropdownPro dropdown = root.AddComponent<TMP_DropdownPro>();
            dropdown.targetGraphic = backgroundImage;
            SetDefaultColorTransitionValues(dropdown);
            dropdown.template = mask.GetComponent<RectTransform>();
            dropdown.captionText = labelText;
            dropdown.itemText = itemLabelText;

            // Setting default Item list.
            itemLabelText.text = "Option A";
            dropdown.options.Add(new TMP_DropdownPro.OptionData {text = "Option A" });
            dropdown.options.Add(new TMP_DropdownPro.OptionData {text = "Option B" });
            dropdown.options.Add(new TMP_DropdownPro.OptionData {text = "Option C" });
            ...
            maskRT.anchoredPosition = new Vector2(0, 2);
            maskRT.sizeDelta = new Vector2(0, 150);
